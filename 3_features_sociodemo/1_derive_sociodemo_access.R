...
#
# Variables derivees socio-demographiques & acces financier — Personne 2
# Lit : data/output/findex_uemoa_clean.csv
# Produit : data/output/findex_uemoa_features.csv
# =============================================================================
...
message("  + 4 variables derivees : groupe_age, jeune_15_24, detention_carte, inclusion_financiere")
...
incl <- df %>%
  group_by(pays) %>%
  summarise(taux = round(mean(inclusion_financiere, na.rm = TRUE) * 100, 1),
            .groups = "drop")
